      ...
      <section className="relative bg-[#1a1a1a] overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 py-32 md:py-44">
          ...
          <p className="mt-6 text-lg text-gray-300 max-w-xl">
            Des voitures, Vélos et camions disponibles à la location. Réservez
            en quelques clics aux meilleurs prix.
          </p>
          <div className="mt-10">
            <Link
              to="/catalog"
              className="bg-[#ff5000] text-white font-bold text-lg px-8 py-4 rounded hover:bg-[#e04800] transition"
            >
              Voir nos véhicules
            </Link>
          </div>
      ...
      <section className="bg-[#f4f5f6] py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-gray-500 mb-10">
            Choisissez parmi notre flotte de véhicules disponibles
          </p>
            ...
            {vehicles.slice(0, 6).map((v) => (
              ...
              >
                <div className="bg-[#1a1a1a] h-48 flex items-center justify-center">
                  <span className="text-8xl opacity-60 group-hover:opacity-100 group-hover:scale-110 transition">
                    {TYPE_ICONS[v.type] || "🚗"}
                  </span>
                </div>
                <div className="p-6">
                  ...
                  <div className="mt-1 text-sm text-gray-500">
                    ...
                    {v.type === "BIKE" &&
                      (v.electric ? "Électrique" : "Non électrique")}
                  ...
                  <div className="mt-4 flex items-end justify-between">
                    ...
                    <Link
                      to={`/book/${v.id}`}
                      className="bg-[#ff5000] text-white text-sm font-bold px-5 py-2.5 rounded hover:bg-[#e04800] transition"
                    >
                      Réserver
                    </Link>
                  </div>
          ...
          {vehicles.length > 6 && (
            <div className="mt-10 text-center">
              <Link
                to="/catalog"
                className="text-[#ff5000] font-bold text-lg hover:underline"
              >
